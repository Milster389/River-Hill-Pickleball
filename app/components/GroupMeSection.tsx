    ...
    <section id="groupme" className="groupme-section">
      <div className="groupme-inner">
        ...
        <p className="section-sub" style={{ margin: '0 auto 1.5rem' }}>
          Get real-time updates on meetings, events, and club news. Meeting times are announced here first, so don&apos;t miss out.
        </p>
        <div className="member-count-badge">
          <span>●</span> 80+ members active in the group
        </div>
